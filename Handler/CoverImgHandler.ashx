<%@ WebHandler Language="C#" Class="CoverImgHandler" %>
...
/// /文章图片上传
/// </summary>
public class CoverImgHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (file != null)
        {
            ...
            string path = "/files/uploads/" + userid + "/Article/";
           ...
           // DB_2.InsertCoverImg(userid, path + saveName);//添加到数据库
